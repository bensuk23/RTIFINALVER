...
public class HandlerHtml implements HttpHandler {
    ...
    public void handle(HttpExchange exchange) throws IOException
    {
        ...
        System.out.println("handlers.HandlerHtmlwtf (methode " + requestMethod + ") = " + requestPath + " --> ");

        if(requestPath.endsWith(".html") || requestPath.endsWith("/"))
        {
            String fichier = null;
            if(requestPath.endsWith(".html"))
                fichier = "ServeurHttp/src/Web/html/" + requestPath;
            else if(requestPath.endsWith("/stock"))
                fichier = "ServeurHttp/src/Web/html/stock.html";

...
public class RequeteGetFacture implements Requete
{
    ...
    public RequeteGetFacture(int idfp, PrivateKey clePriveeClient) throws InvalidKeyException, SignatureException, IOException, NoSuchAlgorithmException, NoSuchProviderException {
        idf = idfp;
        ...
        dos.writeUTF(String.valueOf(idf));
